...
point.body1='Front contact patch';
point.body2='ground';
...
point.body1='Rear contact patch';
point.damping=[20000/u;0];
the_system.item{end+1}=point;
...
item.name='Rear contact patch';
item.location=[0;0;0];
the_system.item{end+1}=item;
item={};

item.type='rigid_point';
item.name='Front contact patch constraint';
item.body1='Front contact patch';
item.body2='Front wheel, bike';
item.location=[p6(1);0;0];
item.forces=2;
item.moments=3;
item.axis=[0;1;0];
...
item.name='Rear contact patch constraint';
item.body1='Rear contact patch';
item.body2='Rear wheel, bike';
item.location=[0;0;0];
the_system.item{end+1}=item;
item={};

item.type='rigid_point';
item.name='Front tire, sidewall';
item.body1='Front wheel, bike';
item.body2='Front contact patch';
item.location=[p6(1);0;0];
%item.stiffness=[85000,0];
%item.damping=[0;0];
item.forces=1;
item.moments=0;
item.axis=[0;1;0];
...
item.name='Rear tire, sidewall';
item.body1='Rear wheel, bike';
item.body2='Rear contact patch';
item.location=[0;0;0];
the_system.item{end+1}=item;
item={};
...
% item.type='sensor';
% item.name='Front tire camber';
% item.body1='Front wheel, bike';
% item.body2='ground';
% item.location1=[p6(1);0;0];
% item.location2=[p6(1);0;0]-[0.1;0;0];
% item.order=1;
% item.twist=1;
% the_system.item{end+1}=item;
% 
% item.name='Roll angle';
% item.name='Rear tire camber';
% item.body1='Rear wheel, bike';
% item.body2='ground';
...
% item={};
% item.type='actuator';
% item.name='Front camber thrust';
% item.body1='Front wheel, bike';
% item.body2='ground';
% item.location1=[p6(1);0;0];
% item.location2=[p6(1);0;0]-[0;0.1;0];
% the_system.item{end+1}=item;
% 
% item.name='Rear camber thrust';
% item.body1='Rear wheel, bike';
% item.body2='ground';
% item.location1=[0;0;0];
