...
m=200; % chassis mass 120.63 + ~80 driver
...
kt=75000; % tire stiffness (N/m)

ct=25000; % cornering stiffness (N/rad)
% model assumes equals tire damping in lateral and longitudinal, none in vertical
...
item.name='Chassis';
item.mass=m;
item.momentsofinertia=[27;61;61];
%[22.331;51.266;56.038] + ~[5;10;5] for driver
