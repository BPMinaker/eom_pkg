...
the_system=trailing(the_system,0,g);

item.type='spring';
item.name='Anti-roll bar';
item.body1='LF Anti-roll arm';
item.body2='RF Anti-roll arm';
item.location1=[2.33;-.28;.155];                %Links both antiroll arm MOUNTS together
item.location2=[2.33;.28;.155];
item.stiffness=13808;                           
item.damping=0;
item.twist=1;
the_system.item{end+1}=item;
...
item.location1=[-.2;-.25;.23];
item.location2=[-.2;.25;.23];              
item.stiffness=8234;
item.damping=0;
item.twist=1;
the_system.item{end+1}=item;
...
item.body2='RR Wheel+hub';
item.location1=[0;.64;0.3];
item.location2=[0;.74;0.3];
item.twist=1;
item.gain=1;
the_system.item{end+1}=item;
item={};
...
item.body1='Chassis';
item.body2='ground';
item.location1=[2.62;-.74;0.4];
item.location2=[2.62;-.74;0.0];
item.twist=0;
item.order=1;
the_system.item{end+1}=item;
