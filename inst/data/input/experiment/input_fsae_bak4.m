...
body.type='body';
body.name='Chassis';
body.location=[-0.8;0;0.4]; %% Estimate based on weight dist.    %[-0.387;0;0.416];
...
body.mass=20;  %approximate   
body.momentsofinertia=[0.167;0.198;0.106]; 
body.velocity=[u;0;0];
the_system.item{end+1}=body;
the_system.item{end+1}=weight(body,g);

body.name='Driver';  %data is from 2013 car
body.mass=80;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Front Suspension _Needs Update
body.type='body';
...
link.body2='Chassis';
link.location1=[-1.555;0;0.063]; %precisely y=0.001
...
spring.location1=[-0.115;0.110;0.146];
spring.location2=[-0.115;-0.110;0.146];
...
point.body2='Chassis';
point.location=[-0.115;0.110;0.146];
point.forces=3;
point.moments=2;
point.axis=[0;1;0];
...
body.mass=0;
body.location=[-0.115;0.110;0.146];
...
link.location1=[0;0.110;0.076];
link.location2=[0;0.110;0.146]; 
the_system.item{end+1}=link;
...
spring.location1=[-1.5;0.190;0.323];
spring.location2=[-1.5;-0.190;0.323];
