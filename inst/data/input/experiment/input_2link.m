function the_system=input_2link(q,varargin)
the_system.item={};

% input_2link.m is for use with EOM
...
item.body1='chassis';
item.body2='spindle';
item.location1 = CF.length*[0;-30;20.1];
item.location2 = CF.length*[0;-30;12.1];
item.stiffness=40000;
item.damping=1000;
the_system.item{end+1}=item;
item = {};
