function the_system=input_fsae4(varargin)
the_system.item={};
...
body.name='r-axle-t';
body.mass=5;
body.momentsofinertia=[1/12*5*1.4^2;0;1/12*5*1.4^2];
body.productsofinertia=[0;0;0];
body.location=[-0.762;0;0.3286];
the_system.item{end+1}=body;
the_system.item{end+1}=weight(body,g);

body.name='r-axle-b';
body.location=[-0.762;0;0.1286];
the_system.item{end+1}=body;
the_system.item{end+1}=weight(body,g);
...
point.type='rigid_point';
point.name='lr';
point.body1='r-axle-t';
point.body2='lr-axle';
point.location=[-0.762;0.55;0.3286];
point.forces=3;
point.moments=2;
point.axis=[1;0;0];
the_system.item{end+1}=point;
...
point.type='rigid_point';
point.name='lr';
point.body1='r-axle-b';
point.body2='lr-axle';
point.location=[-0.762;0.55;0.1286];
point.forces=3;
point.moments=2;
point.axis=[1;0;0];
the_system.item{end+1}=point;
...
point.name='rear upper';
point.body1='r-axle-t';
point.body2='chassis';
point.axis=[0;1;0];
point.forces=1;
point.moments=0;
point.stiffness=[5000;0];
point.location=[-0.762;0;0.3];
the_system.item{end+1}=point;
