function the_system=input_ex_freqdamp(~,varargin)
the_system.item={};
...
%% Add a spring, with damping, to connect our body to ground, aligned with x-axis
item.type='flex_point';
item.name='damp-s';
item.body1='block';
item.body2='zero';
item.location=[0;0;0.75];
item.stiffness=[0;0]; %(AE/L)
