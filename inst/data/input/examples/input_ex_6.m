function the_system=input_ex_6(varargin)
the_system.item={};

%% Copyright (C) 2008, Bruce Minaker
%% This file is intended for use with Octave.
%% input_ex_6.m is free software; you can redistribute it and/or modify it
%% under the terms of the GNU General Public License as published by
%% the Free Software Foundation; either version 2, or (at your option)
%% any later version.
%%
%% input_ex_6.m is distributed in the hope that it will be useful, but
...
%% A single body, tied to the ground with a 'line spring', i.e., a spring defined by two end points, with an external load at the mass centre.  Like example 5, but with flexible connection.  Constrained to planar motion.

%% Add one rigid body, along the z-axis
item.type='body';
item.name='block';
item.mass=5;
...
%% Tie body to ground with a spring
item.body1='ground';
item.body2='block';
item.type='spring';
item.name='spring1';
...
item.type='actuator';
item.name='actuator two';
item.body1='block';
item.body2='ground';
item.location1=[0.1;0;0.5];
item.location2=[0.1;0;0.4];
the_system.item{end+1}=item;
