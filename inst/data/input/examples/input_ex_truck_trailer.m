function the_system=input_ex_truck_trailer(u,varargin)
the_system.name='Truck Trailer';
the_system.item={};
...
params.a=1.289;  %% front axle to truck cg
params.b=2.885-1.289;  %% rear axle to truck cg
params.cf=80000;
params.cr=80000;
params.m=16975/9.81;
params.I=3508;
