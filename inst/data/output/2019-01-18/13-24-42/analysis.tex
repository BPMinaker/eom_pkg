...
\end{footnotesize}
\end{center}
There are 9 degrees of freedom.  There are 4 oscillatory modes, 11 damped modes, 3 unstable modes, and 0 rigid body modes.
\pagebreak
...
\end{tikzpicture}
\end{footnotesize}
\caption{Frequency response: Front brake}
\label{bode_plot_1}
\end{center}
\end{figure}
