...
after row=\midrule},
every last row/.style={after row=\bottomrule \multicolumn{14}{l}{$^\dagger$Inertias are defined as the positive integral over the body, e.g., $I_{\text{xy}}=+\! \int \! r_\text{x}r_\text{y} \,\text{d}m $.}},
