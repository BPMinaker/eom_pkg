...
\end{footnotesize}
\end{center}
There are 1 degrees of freedom.  There are 1 oscillatory modes, 1 damped modes, 0 unstable modes, and 0 rigid body modes.
\pagebreak
...
\addlegendentry{sensor 1/actuator 1}
\end{semilogxaxis}
\end{tikzpicture}
\begin{tikzpicture}
...
\end{tikzpicture}
\end{footnotesize}
\caption{Frequency response: actuator 1}
\label{bode_plot_1}
\end{center}
\end{figure}
